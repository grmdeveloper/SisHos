...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
               <form action="{{ url('/unidade')}}" method="POST" id="form">
                  {{ csrf_field() }}

                  <div class="form-group">
                        <label for="formGroupExampleInput">Nome da Unidade</label>
                      ...
                      <div class="form-group">
                        ...
                        <input id="endereco" name="endereco" type="text" class="form-control" placeholder="Another input">
                      </div>
